import numpy as np
from specie_resolved_comparison import mod_interp_obs_concat
...
if sys.argv[1] == 'all':
    ...
    pd_sta_all.to_pickle(f'../outputs/all_arctic_stations_conc_{global_vars.exp_name}.pkl')
...
if sys.argv[1] == 'MH':
    ...
    pd_MH0209.to_pickle(f'../outputs/MH{year}_conc_{global_vars.exp_name}.pkl')
...
# personal communication
    ...
    pd_MH15 = mod_interp_obs_concat.interp_conc_arctic_stations('ac3_arctic',
                                                      ...
                                                      'MH18',
                                                                ...
                                                                years,
                                                                global_vars.yr_exp_var_names[year][1:])
    pd_MH15.to_pickle(f'../outputs/MH{year}_conc_{global_vars.exp_name}.pkl')
...
if sys.argv[1] == 'AI':
    ...
    pd_AI.to_pickle(f'../outputs/AI0307_conc_{global_vars.exp_name}.pkl')
