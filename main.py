...
if __name__ == '__main__':
    ...
    dates, PASCAL, PI_ICE, CVAO, SVAL_14_15, SVAL_18_19, SVAL_18, SVAL_19, RS_18_20 = (
    ...
    pd_obs_mo_cvao = mod_interp_obs_concat.interp_conc_stations(data_dir,
                                                                ...
                                                                CVAO[2],
                                                                'CVAO')
    pd_obs_mo_sval_14_15 = mod_interp_obs_concat.interp_conc_stations(data_dir,
                                                                      exp,
                                                                      SVAL_14_15[1],
                                                                      SVAL_14_15[2],
                                                                      'SVD14')
    ...
    pd_obs_mo_sval_18 = mod_interp_obs_concat.interp_conc_stations(data_dir,
                                                                   ...
                                                                   SVAL_18[2],
                                                                 'SVD18')
    pd_obs_mo_sval_19 = mod_interp_obs_concat.interp_conc_stations(data_dir,
                                                                   exp,
                                                                   SVAL_19[1],
                                                                   SVAL_19[2],
                                                                'SVD19')
