...
if __name__ == '__main__':
    ...
    dates, PASCAL, PI_ICE, CVAO, SVAL_14_15, SVAL_18_19, RS_18_20 = (
    ...
    pd_obs_mo_cvao = mod_interp_obs_concat.interp_conc_stations(data_dir,
                                                                ...
                                                                CVAO[2],
                                                                'CVAO')
    pd_obs_mo_sval_14_15 = mod_interp_obs_concat.interp_conc_stations(data_dir, exp, SVAL_14_15[1], SVAL_14_15[2],
                                                                      'SVD14')
    ...
    conc_pd_pol_tot = pd.concat(
        [pd_obs_mo_pascal, pd_obs_mo_cvao, pd_obs_mo_pi_ice, pd_obs_mo_sval_14_15, pd_obs_mo_sval_18_19])
    ...
    conc_all_pr = pd.concat([pd_obs_mo_cvao, pd_obs_mo_sval_14_15, pd_obs_mo_sval_18_19,pd_obs_mo_rs_18_20])
